							...
							<u-collapse-item :clickable="false" :border="false" :isLink="false" :ref="'u_collapse_item_'+item.id">
								<view class="l-collapse-title" slot="right">
									...
									<view class="order-btn">
										...
										<view v-if="item.pay_status == 2 && item.status == 2" class="btn bg2">
											待买家确定收货
										</view>
								...
								<view class="content-box">
									...
									<block v-if="item.adds_mobile && item.adds_mobile.length > 0">
									...
									<view class="content-goods">
										<view class="goods" @tap.stop.prevent="toSliderUrl(git.to_target_type, git.goods_id)"
