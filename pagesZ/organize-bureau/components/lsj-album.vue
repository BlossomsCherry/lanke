<template>
	<view class="album" :style="[{zIndex: zIndex,background: background,position: position}]">
							...
							<block v-if="!foldArray[i] || getCurrToListIndex(i,o) < foldNum">
								<view class="flex__img">
									...
									<view v-if="foldArray[i] && getCurrToListIndex(i,o) === foldNum - 1 && getResidualCount(i,o) > 0"
										class="more" :style="[{zIndex: zIndex+1,borderRadius: round}]" @click.stop="foldArray[i] = false">
