...
export default {
	...
	data() {
	    return {
			pagebgcolorClass: 'pagebg_white',fph: false,mytoast_data: {},pageTheme: 'default',page__scene__: 104,
			filterIndex: 0,
			paras: {
				classify: {
					id: 0,
