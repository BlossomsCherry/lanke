...
import PetAdoptionMine from '@/pagesP/pet-adoption/index/mine/index.vue'
...
export default {
  name: 'index',
  components: { PetAdoptionHomeNavbar, PetAdoptionMine, PetAdoptionHome },
...
<z-paging ref="pagePaging" :auto-clean-list-when-reload="false" refresher-only @onRefresh="onRefresh" @scrolltolower="scrollToLower" :refresher-enabled="tabbarIdx === 0">
		...
		<view slot="top">
		  <pet-adoption-home-navbar :city="currentCity" v-show="tabbarIdx === 0" />
		</view>
