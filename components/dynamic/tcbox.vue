		...
		<view class="card-item" @click="toDynamic">
			...
			<view class="card-item-info">
				<view class="item-info-user" @click.stop="toUser">
					...
					<view class="info-user-name ohto">
						<view class="mold">{{config.app.snstczs.type[item.mold].name}}</view>
						<view class="user-name">{{item.tc.lxr}}</view>
						<view class="mold-tel"><image src="/static/img/tc/tel.svg" mode="aspectFill"></image>电话</view>
					</view>
				...
				<view class="item-info-quantity df">
					...
					<view class="df">
						<image src="/static/img/pl.svg"></image>
						<text>{{item.comment_count?item.comment_count:'评论'}}</text>
						<image @click.stop="likeClick" v-if="item.is_like" src="/static/img/xhs.svg"></image>
						<image @click.stop="likeClick" v-else src="/static/img/xh.svg"></image>
