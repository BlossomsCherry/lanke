...
<view :class="'mini-page-wrap global-theme-' + global__theme__  + ' global-platform-' + global__platform__ + ' global-device-' + global__device__ + ' global-tenant-' + global__tenant__.tenant_id" :data-theme="global__theme__  ">
	<view class="mini-page-body">
		<navBar :back="true" :home="fph" :color="global__theme__ == 'black' ? '#ffffff' : '#000000'" :background="global__theme__ == 'black' ? '#19191e' : '#ffffff'">
			<view class="message-nav-center" slot="center" @tap.stop.prevent="toSliderUrl(4, oid)">
								...
								<view class="left">
									...
									<block v-else-if="row.mode == 'bureau'">
										<view class="bureau_view">
											<view class="list_box" @tap.stop.prevent="toSliderUrl(34, row.bureau.id)">
												<view class="list_box_cont">
													<image class="image" :src="row.bureau.pic"
														mode="aspectFill"></image>
													<view class="cont">
														<view class="title_ u-line-1">
															{{ row.bureau.title }}
														</view>
														<view class="pirce">{{ row.bureau.least_price_tip }}</view>
														<view class="other-text-wrapper">
														  <u-icon name="clock" size="25" color="A3A3A3"/>
														  <view class="time">{{ row.bureau.service_date_start + ' ' + row.bureau.service_time_start }}</view>
														</view>
														
														<view class="other-text-wrapper">
														  <u-icon name="map" size="25" color="A3A3A3"/>
														  <view class="address u-line-1">{{ row.bureau.distance }} {{ row.bureau.address_detailed }}</view>
														</view>
													</view>
												</view>
											</view>
